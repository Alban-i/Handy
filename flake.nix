{
  description = "Katib - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          katib = pkgs.rustPlatform.buildRustPackage {
            pname = "katib";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/cjpais/Katib";
          ...
          default = self.packages.${system}.katib;
        }
      );
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Katib development environment"
              bun install
